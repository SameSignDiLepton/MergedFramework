...
double ptBins[15] = {30., 34., 38., 43., 48., 55., 62., 69., 78.0, 88.0, 100., 115., 140., 200., 400.};
...
/*
double ptBins[5]  = {20., 25., 40, 80., 400.}; 
double etaBins[6] = {0.0, 0.4, 0.8, 1.37, 1.52, 2.5};
int NptBins = 4;
int NetaBins = 5;
*/

double ptBins[3]  = {20., 50, 200.}; 
...
string file_path_mc;
  ...
  if(isEle) {
  	 ...
  	 file_path_data = "/afs/cern.ch/user/s/sarnling/MergedFramework/test/ntuple_mc_tau_fewbins.root";
  	 file_path_mc = "/afs/cern.ch/user/s/sarnling/MergedFramework/test/ntuple_mc_tau_fewbins.root";
  	 cout << "hej1" << endl;
  }	
